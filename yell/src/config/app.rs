        ...
        web::scope("/api")
            ...
            .service(
                web::scope("/template")
                    ...
                    .service(web::resource("/update").route(web::post().to(notify::update_template)))
                    .service(web::resource("/delete").route(web::post().to(notify::delete_template)))
                    .wrap(Authentication)
            )
            ...
            .service(
                web::scope("/channel")
                    .service(web::resource("/get").route(web::get().to(notify::get_channel_configs)))
